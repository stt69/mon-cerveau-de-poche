## Chapitre 57 — Prévoir les dates de récolte

---

La date de récolte optimale dépend de la variété, des degrés-jours et de la météo. La prévoir permet d'organiser matériel et main-d'œuvre.

Ce chapitre prédit le **jour de récolte** (1–365) à partir des données de campagne.

---

### Le fichier exemple

> **Fichier** : `programs/excel/cas_agriculture_recolte.xlsx`
...
| Variete | Variété (1–4) | 2 |
| Date_semis_jour | Jour de semis (1–365) | 105 |
| Degres_jours_cumul | Degrés-jours cumulés | 1500.0 |
| Pluviometrie_mm | Pluviométrie (mm) | 350.0 |
| **Date_recolte_jour** | **Jour de récolte (1–365)** | **220** |

La colonne **Date_recolte_jour** est la cible.
...
Ouvrez *Mon Cerveau de Poche*. Chargez `programs/excel/cas_agriculture_recolte.xlsx`.

Vérifiez l'aperçu : environ 200 lignes, 6 colonnes, pas de cellule vide, valeurs numériques.

#### Étape 2 — Choisir la cible

Sélectionnez **Date_recolte_jour** comme colonne cible.
...
Organisez moissonneuses et main-d'œuvre autour de la date prédite ± marge.
...
1. Chargez `cas_agriculture_recolte.xlsx` et entraînez sur **Date_recolte_jour**.
