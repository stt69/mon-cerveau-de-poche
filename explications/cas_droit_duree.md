## Chapitre 41 — Prévoir la durée d'une procédure

---

« Combien de temps va prendre mon affaire ? » Répondre au doigt mouillé engage le cabinet. Votre historique de procédures terminées contient déjà la réponse statistique.

Ce chapitre prédit la **durée en mois** d'une procédure à partir de ses caractéristiques initiales.

---

### Le fichier exemple

> **Fichier** : `programs/excel/cas_droit_duree.xlsx`
...
|---------|-------------|---------|
| Type_procedure | Type de procédure (1–5) | 3 |
| Juridiction | Juridiction (1–4) | 2 |
| Recours | Recours (0–2) | 1 |
| Complexite | Complexité (1–5) | 3 |
| Pieces_jointes | Nombre de pièces jointes | 52 |
| **Duree_mois** | **Durée (mois)** | **12** |

La colonne **Duree_mois** est la cible.
...
Ouvrez *Mon Cerveau de Poche*. Chargez `programs/excel/cas_droit_duree.xlsx`.

Vérifiez l'aperçu : environ 200 lignes, 6 colonnes, pas de cellule vide, valeurs numériques.

#### Étape 2 — Choisir la cible

Sélectionnez **Duree_mois** comme colonne cible.
...
Annoncez au client une durée réaliste avec marge ; testez l'effet d'un recours.
...
1. Chargez `cas_droit_duree.xlsx` et entraînez sur **Duree_mois**.
