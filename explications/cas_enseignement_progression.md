## Chapitre 36 — Estimer la progression d'un élève

---

Quelle note peut-on raisonnablement attendre au prochain trimestre ? L'assiduité, le travail personnel et la participation jouent un rôle — mais dans quelles proportions pour votre établissement ?

Ce chapitre estime la **note finale** à partir d'indicateurs disponibles en cours de trimestre. Usage bienveillant et anonymisé uniquement — pour accompagner, pas pour étiqueter.

---

### Le fichier exemple

> **Fichier** : `programs/excel/cas_enseignement_progression.xlsx`
...
|---------|-------------|---------|
| Assiduite_pct | Assiduité (%) | 70.0 |
| Heures_travail_perso | Heures de travail personnel / semaine | 10.0 |
| Participation | Participation (1–5) | 3 |
| Niveau_entree | Niveau à l'entrée | 10.0 |
| Soutien_scolaire | Soutien scolaire (0/1) | 0 |
| **Note_finale** | **Note finale** | **10** |

La colonne **Note_finale** est la cible.
...
Ouvrez *Mon Cerveau de Poche*. Chargez `programs/excel/cas_enseignement_progression.xlsx`.

Vérifiez l'aperçu : environ 200 lignes, 6 colonnes, pas de cellule vide, valeurs numériques.

#### Étape 2 — Choisir la cible

Sélectionnez **Note_finale** comme colonne cible.
...
Écart fort entre prédiction et niveau attendu → entretien bienveillant, jamais étiquetage.
...
1. Chargez `cas_enseignement_progression.xlsx` et entraînez sur **Note_finale**.
